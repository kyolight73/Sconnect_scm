        ...
        <div class="modal-content">
            <form action="/ticket/add" id="frm-ticket" name="frm-ticket" method="post">@csrf
                ...
                <div class="modal-body" id="body-ticket">
                    <input type="hidden" name="ticket-video-id" id="ticket-video-id"
                           value="{{ !empty($selected_video) ? $selected_video->id : 0 }}"/>
                    <input type="hidden" name="ticket-id" id="ticket-id" value="0"/>
                    <div class="input-group">
                        <div class="input-group-prepend">
                            <span class="input-group-text">Tiêu đề ticket</span>
                        </div>
                        <input type="text" class="form-control" name="ticket-title" id="ticket-title"
                               placeholder="Nhập tiêu đề" autofocus required>
                    </div>
                    <div class="margin-top round4"><strong>Video:</strong> <span
                            id="ticket-video-title">{{ !empty($selected_video) ? $selected_video->name : '' }}</span>
                    </div>
                    <div class="margin-top ptop-10 round4"><strong>Link:</strong> <span
                            id="ticket-video-url">{{ !empty($selected_video) ? $selected_video->url : '' }}</span></div>
                    <div id="qtk-mkt"></div>
                    <div class="row">
                        <div class="col col-md-6 ptop-10">
                            <div class="round4">
                                ...
                                <div class="input-group" style="width: 330px!important">
                                    ...
                                    <input type="text" class="form-control" name="ticket-promote-time"
                                           id="ticket-promote-time">
                                </div>
                            </div>
                        </div>
                        <div class="col col-md-6 ptop-10">
                            <div class="round4">
                                ...
                                <div class="input-group" style="width: 330px!important">
                                    ...
                                    <input type="text" class="form-control" name="ticket-budget" id="ticket-budget"
                                           style="text-align: right;" placeholder="0" required>
                    ...
                    <div class="round4" style="margin-top: 20px;">
                        <div
                            style="float:left; margin-top: -15px; background-color: #fff; font-weight: bold; padding: 0px 10px;">
                            Đối tượng mục tiêu
                        </div>
                        <div class="row" style="clear: both;">
                            <div class="col-6 ptop-10">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="icheck-primary d-inline ptop-10">
                                        <input type="radio" id="ticket-radio-allgender" name="ticket-gender" value="0"
                                               checked="checked">
                            ...
                            <div class="col-6 ptop-10">
                                ...
                                <input type="text" class="form-control" name="ticket-ages" id="ticket-ages"
                                       style="text-align: right;" placeholder="0" required>
                            </div>
                        </div>
                        <div class="ptop-10">
                            <strong>Vùng địa lý</strong>
                            <input type="text" class="form-control" name="ticket-location" id="ticket-location"
                                   placeholder="US, Brazil, Anh, ..." required>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col col-md-6 ptop-10">
                        ...
                        <div class="col col-md-6 ptop-10">
                            <div class="round4">
                                ...
                                <input type="text" class="form-control" name="ticket-camp-id" id="ticket-camp-id"
                                       placeholder="Dành cho MKT điền">
                            </div>
                        </div>
                    </div>
                    <div class="margin-top ptop-10 round4">
                        <strong>Từ khoá</strong>
                        <input type="text" class="form-control" name="ticket-keyword" id="ticket-keyword"
                               placeholder="Nhập từ khóa ..." required>
                    </div>
                    <div class="margin-top ptop-10 round4">
                        <strong>Ghi chú</strong>
                        <textarea class="form-control" rows="3" name="ticket-note" id="ticket-note"
                                  placeholder="Nội dung ghi chú..."></textarea>
                    </div>
                    <div class="ptop-10">
                        <div class="form-group">
                            @if (\App\Models\Role::QTK == Auth::user()->permission)
                                <div class="icheck-primary d-inline">
                                    <input type="radio" id="ticket-radio-draft" name="ticket-workflow-position"
                            ...
                            @endif
                            @if (\App\Models\Role::MKT == Auth::user()->permission)
                                <div class="icheck-primary d-inline">
                                    <input type="radio" id="ticket-radio-review" name="ticket-workflow-position"
                                           value="2">
                                    <label for="ticket-radio-review" class="phorz-10 margin-top">MKT đang duyệt</label>
                                </div>
                                <div class="icheck-primary d-inline">
                                    <input type="radio" id="ticket-radio-comment" name="ticket-workflow-position"
                                           value="3">
                                    <label for="ticket-radio-comment" class="phorz-10 margin-top">Đang thảo luận</label>
                                </div>
                                <div class="icheck-primary d-inline">
                                    <input type="radio" id="ticket-radio-running" name="ticket-workflow-position"
                                           value="4">
                                    <label for="ticket-radio-running" class="phorz-10 margin-top">Đang chạy</label>
                                </div>
                                <div class="icheck-primary d-inline">
                                    <input type="radio" id="ticket-radio-paused" name="ticket-workflow-position"
                                           value="5">
                                    <label for="ticket-radio-paused" class="phorz-10 margin-top">Tạm dừng</label>
                                </div>
                                <div class="icheck-primary d-inline">
                                    <input type="radio" id="ticket-radio-finish" name="ticket-workflow-position"
                                           value="6">
