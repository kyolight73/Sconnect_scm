...
@section('content')
    <div class="container">
        {!! App\Utils::createBreadcrumb(['Hệ thống', 'Thiết lập chung']) !!}
        <div class="row">
            <div class="col-md-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="input-group">
                            <input type="text" id="dept-prefix" name="dept-prefix"
                                placeholder="Loại phòng, ban, dự án, ..." class="form-control">
                                    ...
                                    <tr style="background-color: #dee2e6">
                                        ...
                                        <th style="width: 120px; text-align: center;">
                                            <span class="btn btn-block btn-default btn-sm" id="delete-prefix">
                                                <i class="far fa-trash-alt" style="color:#ff5648!important"></i> &nbsp; Xóa
                                            </span>
                                        </th>
                                    </tr>
                                </thead>
            ...
            <div class="col-md-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="input-group">
                            <input type="text" id="title" name="title" placeholder="Tên chức vụ"
                                class="form-control">
                            <span class="input-group-append">
    ...
    <script>
        ...
        function edit_prefix(id) {
            ...
            var input = '<div class="input-group">' +
                '<input type="text" id="prefix-name" value="' + span_prefix_name.html().replace(/"/g, '&quot;') +
                '" class="form-control" />' +
        ...
        function edit_title(id) {
            ...
            var input = '<div class="input-group">' +
                '<input type="text" id="title-name" value="' + span_title_name.html().replace(/"/g, '&quot;') +
                '" class="form-control" />' +
                '<div class="input-group-append cursor-hand" id="btn-save">' +
                '<span class="input-group-text" id="icon-check"><i class="fas fa-check" style="width: 16px;"></i></span>' +
                '</div></div>';
