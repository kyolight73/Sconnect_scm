...
class ChannelController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        try {
            ...
            * */
            $staff_list = User::getAllStaffInner($dept->id,  Auth::user()->permission = 1);
            ...
            * */
            ...
            return view('channel')->with(compact(
                'id',
                'sl_platform',
                'sl_topic',
                'sl_manager',
    ...
    public function collectChannelInfo($channel_id)
    {
        try {
            ...
            return response()->json([
                'status' => 'success', 'updated_at' => Carbon::now()->format('Y-m-d H:i:s'),
